...
def se_resnet18():
    ...
    """
    model = ResNet(SEBasicBlock, [2, 2, 2, 2], num_classes=10)
...
def se_resnet34():
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(SEBasicBlock, [3, 4, 6, 3], num_classes=10)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def se_resnet101():
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(SEBottleneck, [3, 4, 23, 3], num_classes=10)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def se_resnet152():
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(SEBottleneck, [3, 8, 36, 3], num_classes=10)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model

...
class RepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=10, width_multiplier=None, override_groups_map=None, deploy=False,
                 use_se=False):
...
def create_RepVGG_A0(deploy=False):
    return RepVGG(num_blocks=[2, 4, 14, 1], num_classes=10,
...
def create_RepVGG_B0(deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], num_classes=10,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy)
...
def create_RepVGG_D2se(deploy=False):
    return RepVGG(num_blocks=[8, 14, 24, 1], num_classes=10,
